...
@tgclient.on(NewMessage(pattern=r"^\.fakedice(?: |$)(.*)", outgoing=True))
...
DESC = "This module allows you to launch a dice with any destination value you desire.\n**WARNING:** This module sends and deletes messages repeatedly, in order to get the correct value you want. Use at your own risk as you could be flagged for spam!"
USG = "`.fakedice` <value>\
